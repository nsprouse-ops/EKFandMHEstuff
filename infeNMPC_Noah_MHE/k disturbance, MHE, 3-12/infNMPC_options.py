class Options:
    ...
    def __init__(self):
        ...
        self.measurement_noise_seeded = True
        ...
        self.F_state_weight = 3.0 #3.691310878592334 #weights on residuals
        self.mhe_e_k_weight = 5
        self.mhe_d_k_arrival_weight = 8
        self.mhe_e_k_bound = .08
        self.mhe_d_k_max_step = .08
        ...
        self.rebuild_setpoints_on_disturbance_change = True
